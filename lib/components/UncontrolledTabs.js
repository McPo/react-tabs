...
var UncontrolledTabs = function (_Component) {
  ...
  UncontrolledTabs.prototype.getChildren = function getChildren() {
    ...
    return _reactChildrenUtilities2.default.deepMap(children, function (child) {
      ...
      if (child.type === _TabList2.default) {
        ...
        result = (0, _react.cloneElement)(child, {
          children: _reactChildrenUtilities2.default.deepMap(child.props.children, function (tab) {
            // null happens when conditionally rendering TabPanel/Tab
            // see https://github.com/reactjs/react-tabs/issues/37
            if (tab === null) {
              return null;
